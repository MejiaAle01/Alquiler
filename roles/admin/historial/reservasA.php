...
<body style="font-family: 'Noto Sans', sans-serif;">
	...
	<main>
		<section class="container-fluid">
			<h4 class="m-2"><a href="../index_admin.php" class="bi-arrow-left text-dark" title="Regresar" role="button"></a> Historial de alquileres </h4>
		</section>
		<section class="container-fluid table-responsive mt-3">
			<a href="reportesA.php" class="bi-file-pdf btn btn-outline-danger mb-3" title="Reportes"> Generar reporte </a>
