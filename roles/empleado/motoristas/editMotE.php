	...
	<main class="p-0 m-5 d-flex justify-content-center">
		<section>
			<form method="POST" class="rounded-3 shadow bg-white" action="">
				...
				<div class="row mb-3">
					<label for="edadMot" class="col-sm-5 ms-1 col-form-label"> Editar edad: </label>
					<div class="col-sm-6">
						<input type="number" min="0" max="100" class="form-control" name="edadMot" required value="<?php echo $edadMo; ?>">
					</div>
				</div>
				<div class="row mb-3">
				...
				<div class="d-flex justify-content-center">
					...
					<a class="btn btn-outline-secondary ms-2" href="motoristasE.php"> Regresar </a>
				</div>
			</form>
			<?php
				if (isset($_POST['actualizar'])) {
					...
					$upd_edadM = $_POST['edadMot'];
					$upd_telM = $_POST['telfMot'];
					$upd_hourM = $_POST['hourMot'];

					// Ejecutamos la sentencia junto con la conexion
					$exec = mysqli_query($conn, "UPDATE motoristas SET Nombre_mot = '$upd_nameM', Edad = '$upd_edadM', Telefono = '$upd_telM', Horario = '$upd_hourM' WHERE ID_MOT = '$editIDM'");
