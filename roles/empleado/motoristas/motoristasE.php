	...
	<main>
		<article class="container-fluid">
			...
			<div class="d-flex mt-2">
				<h4 class="mb-0"> Listado de motoristas </h4>
			</div>
		</article>
			...
			<table class="table table-bordered table-hover table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<a href="editMotE.php?id=<?php echo $idMot; ?>"><i class="bi-pencil-square" style="font-size: 1.5rem;"></i></a>
							<a href="delMotE.php?id=<?php echo $idMot; ?>"><i class="bi-person-x" style="font-size: 1.5rem;"></i></a>
						</td>
					</tr>
					<?php } ?>
				</tbody>
