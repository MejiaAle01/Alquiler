...
<body>
	...
	<main>
		...
		<section class="container-fluid table-responsive mt-3">
			<a href="reportesU.php" class="btn btn-outline-danger m-1" role="button"><i class="bi-file-earmark-pdf-fill fst-normal"> Generar PDF </i></a>
				...
				<tbody>
					...
					<tr>
						...
						<td>
							...
							<a href="#"><i class="bi bi-x-square-fill" style="font-size: 1.5rem; color: #ffc107;"></i></a>
						</td>
			</tr>
			<?php } ?>
		</tbody>
